...
const SearchBox = () => {
  ...
  <div className="rounded-l w-[500px] p-5">
    <div className="flex">
      ...
      <input type="text" className="w-full max-w-[400px] bg-white pl-2 text-base font-semibold outline-0" placeholder="Search Box" id="" />
