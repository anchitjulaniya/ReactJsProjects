    ...
    <div>
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="inline-flex items-center space-x-2">
          ...
          <span className="font-bold hover:cursor-pointer">Comfy Store</span>
        </div>
        </Link>
        <div className="hidden grow items-start lg:flex">
          <ul className="ml-12 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <Link to={item.to}>
                    <p className="inline-flex hover:cursor-pointer items-center text-sm font-semibold text-gray-800 hover:text-gray-900">{item.name}</p>
                </Link>
              </li>
            ))}
          </ul>
              ...
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    ...
                    <span className="font-bold">Comfy Store</span>
                  </div>
                  <div className="-mr-2">
                    <button
                      type="button"
